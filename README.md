...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 16.3h | 24h | 24h | ~4,084h* |
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 333 | 403 | 135K | 30.4M | $55.92 | $411.69 | $0.00 |
...
| **Total** | **1,317** | **1.1M** | **523K** | **87.1M** | **$101.24** | **$649.07** | **$85.65** |

_123.6M total tokens processed. 91.4% cache hit rate._

_$734.72 total saved ($649.07 caching + $85.65 model routing vs all-Opus)._
