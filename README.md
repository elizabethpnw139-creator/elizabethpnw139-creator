...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 15.4h | 24h | 24h | ~4,084h* |
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 317 | 375 | 125K | 29.9M | $54.40 | $404.90 | $0.00 |
...
| **Total** | **1,301** | **1.1M** | **513K** | **86.6M** | **$99.72** | **$642.27** | **$85.65** |

_122.7M total tokens processed. 91.6% cache hit rate._

_$727.92 total saved ($642.27 caching + $85.65 model routing vs all-Opus)._
