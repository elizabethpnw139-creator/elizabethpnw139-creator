...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 7.5h | 24h | 24h | ~4,172h* |
...
_93.3M total tokens processed. 91.8% cache hit rate._

_$370.40 total saved ($284.75 caching + $85.65 model routing vs all-Opus)._
